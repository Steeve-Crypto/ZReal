...
urlpatterns = [
    ...
    path("properties/resolve-address/", property_api.resolve_address, name="api_property_resolve_address"),
    ...
    path("properties/<int:pk>/enrich/", property_api.enrich_property, name="api_property_enrich"),
    path("properties/<int:pk>/enrichment/", property_api.property_enrichment, name="api_property_enrichment"),
    path("properties/<int:pk>/confirm-enrichment/", property_api.confirm_enrichment, name="api_property_confirm_enrichment"),
